  ...
  provideFileDecoration(
    ...
    if (this.untestedFiles.has(filePath)) {
      return {
        ...
        tooltip: 'Grepo: Changed functions lack test coverage',
        propagate: false,
      };
    }
    ...
    if (this.testedFiles.has(filePath)) {
      return {
        ...
        tooltip: 'Grepo: All changed functions have test coverage',
        propagate: false,
      };
    }
    ...
    if (this.impactedFiles.has(filePath)) {
      return {
        ...
        tooltip: 'Grepo: In blast radius of current changes',
        propagate: false,
      };
    }
