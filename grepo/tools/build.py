...
def _run_postprocess(
    ...
    try:
        from grepo.search import rebuild_fts_index
    ...
    try:
        if use_incremental:
            from grepo.flows import incremental_trace_flows

            count = incremental_trace_flows(store, changed_files)
        else:
            from grepo.flows import store_flows as _store_flows
            from grepo.flows import trace_flows as _trace_flows
