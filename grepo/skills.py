...
CLAUDE.md integration for seamless grepo usage.
...
_SKILLS: dict[str, dict[str, str]] = {
    "explore-codebase.md": {
        ...
        "body": (
            "## Explore Codebase\n\n"
            "Use the grepo MCP tools to explore and understand the codebase.\n\n"
            "### Steps\n\n"
            ...
            "PostToolUse": [
                {
                    ...
                    "command": "grepo update --quiet --skip-flows",
                    "timeout": 5000,
                },
            ],
            "SessionStart": [
                {
                    "command": "grepo status --json",
                    "timeout": 3000,
                },
            ],
            "PreCommit": [
                {
                    "command": "grepo detect-changes --brief",
                    "timeout": 10000,
                },
            ],
        }
...
_CLAUDE_MD_SECTION_MARKER = "<!-- grepo MCP tools -->"

_CLAUDE_MD_SECTION = f"""{_CLAUDE_MD_SECTION_MARKER}
## MCP Tools: grepo

**IMPORTANT: This project has a knowledge graph. ALWAYS use the
grepo MCP tools BEFORE using Grep/Glob/Read to explore
...
def inject_platform_instructions(repo_root: Path) -> list[str]:
    ...
    with instructions to prefer grepo MCP tools over
