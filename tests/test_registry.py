...
from grepo.registry import ConnectionPool, Registry, resolve_repo
...
class TestRegistry:
    ...
    def test_register_not_a_repo(self):
        """Registering a dir without .git or .grepo raises ValueError."""
        import pytest
...
class TestCrossRepoSearch:
    def test_cross_repo_search_no_repos(self):
        ...
        from grepo.tools import cross_repo_search_func

        tmp_dir = tempfile.mkdtemp()

        with patch("grepo.registry.Registry") as mock_registry_cls:
