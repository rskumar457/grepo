...
from grepo.graph import GraphStore, _sanitize_name, node_to_dict
from grepo.parser import EdgeInfo, NodeInfo
from grepo.tools import (
...
class TestSanitizeName:
    ...
    def test_node_to_dict_uses_sanitize(self):
        ...
        from grepo.graph import GraphNode
        node = GraphNode(
...
class TestFlowTools:
    ...
    def setup_method(self):
        """Set up a temp dir with .git and .grepo, seed data, build flows."""
        ...
        (self.root / ".git").mkdir()
        (self.root / ".grepo").mkdir()

        db_path = str(self.root / ".grepo" / "graph.db")
    ...
    def _build_flows(self):
        ...
        from grepo.flows import store_flows, trace_flows
...
class TestCommunityTools:
    ...
    def setup_method(self):
        """Set up a temp dir with .git and .grepo, seed clustered graph."""
        self.tmp_dir = tempfile.mkdtemp()
        self.root = Path(self.tmp_dir).resolve()
    ...
    def _build_communities(self):
        ...
        from grepo.communities import detect_communities, store_communities
...
class TestBuildPostprocess:
    ...
    def test_postprocess_none_produces_nodes_no_flows(self):
        ...
        from grepo.tools.build import build_or_update_graph

        with patch(
            "grepo.incremental.get_all_tracked_files",
...
class TestGetMinimalContext:
    ...
    def setup_method(self):
        ...
        db_path = self.root / ".grepo" / "graph.db"
    ...
    def test_returns_required_keys(self):
        from grepo.tools.context import get_minimal_context
