...
from grepo.eval.reporter import (
...
try:
    ...
    from grepo.eval.runner import write_csv
    _HAS_YAML = True
except ImportError:
    _HAS_YAML = False
    write_csv = None  # type: ignore[assignment]
from grepo.eval.scorer import (
    compute_mrr,
...
def test_runner_with_mock_repo():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        from grepo.incremental import full_build, get_db_path
        ...
        from grepo.eval.benchmarks import token_efficiency
        ...
        # Run impact_accuracy
        from grepo.eval.benchmarks import impact_accuracy
        ...
        # Run search_quality
        from grepo.eval.benchmarks import search_quality
        ...
        from grepo.eval.benchmarks import build_performance
...
def test_estimate_tokens_basic():
    ...
    from grepo.eval.token_benchmark import estimate_tokens
...
def test_benchmark_review_workflow():
    ...
    from grepo.eval.token_benchmark import benchmark_review_workflow
...
def test_run_all_benchmarks():
    ...
    from grepo.eval.token_benchmark import run_all_benchmarks
