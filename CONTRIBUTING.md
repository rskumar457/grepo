...
git clone https://github.com/rskumar457/grepo.git
cd grepo
...
# With coverage
uv run pytest --cov=grepo --cov-report=term-missing --cov-fail-under=50
...
6. Ensure linting passes: `uv run ruff check grepo/`
7. Submit a pull request

## Project Structure

```
grepo/                 # Core Python package
...
- Use GitHub Issues: https://github.com/rskumar457/grepo/issues
